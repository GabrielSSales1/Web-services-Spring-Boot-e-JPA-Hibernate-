package com.WorkShop_JPA.Hibernate.projeto.config;

import com.WorkShop_JPA.Hibernate.projeto.entities.Order;
import com.WorkShop_JPA.Hibernate.projeto.entities.User;
import com.WorkShop_JPA.Hibernate.projeto.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.WAITING_PAYDING,u2);
        Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.WAITING_PAYDING,u1);
